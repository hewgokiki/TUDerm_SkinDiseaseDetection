...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void checkpasscode() {
        ...
        int check = dbh.passwordlogin(passcode);
        //System.out.println(check);
        if(check == 1){
            startActivity(new Intent(this, MainPageActivity.class));
            Toast.makeText(this,"ดำเนินการเข้าสู่ระบบ",Toast.LENGTH_SHORT).show();
        }else{
            Toast.makeText(this,"รหัสผ่านไม่ถูกต้อง กรุณาลองอีกครั้ง",Toast.LENGTH_SHORT).show();
            numbers_list.clear();
            view_01.setBackgroundResource(R.drawable.bg_view_grey_oval);
            view_02.setBackgroundResource(R.drawable.bg_view_grey_oval);
            view_03.setBackgroundResource(R.drawable.bg_view_grey_oval);
